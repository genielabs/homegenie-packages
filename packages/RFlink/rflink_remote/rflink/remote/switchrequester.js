[{
  ...
  RenderView: function (cuid, module) {
    ...
    if (!this.Initialized)
    {
      ...
      this.nameButton_Off = widget.find('[data-ui-field=off]');
    ...
    this.nameButton_Off.html(this.commandname_off);
  },

  OnClicked: function() {
    var _this = this;
    _this.iconImage.attr('src', 'pages/control/widgets/rflink/remote/images/light_on.png');
  ...
  OffClicked: function() {
    ...
    _this.iconImage.attr('src', 'pages/control/widgets/rflink/remote/images/light_off.png');
    _this.statusText.html(_this.commandname_off +' was sended!');
    HG.Control.Modules.ServiceCall("Control.Remote","HomeAutomation.RFLink","1",_this.protocolname + '/' + _this.ModuleId + '/' + _this.channel+ '/' +       _this.commandname_off + '/true', function (data) { });
  },
